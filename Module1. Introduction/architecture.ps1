...
$availabilitySet = Get-AzureRmAvailabilitySet -ResourceGroupName $rgName -Name "Adventure-AvailabilitySet"
...
$vmConfig = New-AzureRmVMConfig -VMName 'MyVm-Web' -VMSize 'Standard_DS2'  -AvailabilitySetID $availabilitySet.Id | `
  Set-AzureRmVMOperatingSystem -Windows -ComputerName 'MyVm-Web' -Credential $cred | `
  Set-AzureRmVMSourceImage -PublisherName 'MicrosoftWindowsServer' -Offer 'WindowsServer' `
  -Skus '2012-R2-Datacenter' -Version latest | Add-AzureRmVMNetworkInterface -Id $nicVMweb.Id
